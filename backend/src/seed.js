...
export const seedSettings = {
  ...
  categories: [
    { id: "industrial-pc", name: "Máy tính công nghiệp", shortName: "Industrial PC", description: "Box PC, Panel PC và máy tính Edge AI cho tủ điện, dây chuyền sản xuất.", subcategories: ["Box PC không quạt", "Panel PC & HMI", "Rackmount IPC", "Edge AI Computer", "Màn hình công nghiệp"], visible: true, sortOrder: 1 },
    ...
    { id: "sensors", name: "Cảm biến & đo lường", shortName: "Sensors", description: "Cảm biến đo lực, áp suất, khoảng cách, lưu lượng và vị trí.", subcategories: ["Cảm biến dịch chuyển", "Load cell & lực", "Áp suất & lưu lượng", "Mô-men xoắn", "Nhiệt độ & độ ẩm"], visible: true, sortOrder: 3 },
    ...
    { id: "industrial-iot", name: "Industrial IoT & mạng", shortName: "Industrial IoT", description: "Gateway, bộ chuyển đổi giao tiếp, router và switch công nghiệp.", subcategories: ["IoT Gateway", "Serial Device Server", "Industrial Router", "Industrial Ethernet Switch"], visible: true, sortOrder: 6 },
    ...
    { id: "automation", name: "Tự động hóa & điều khiển", shortName: "Automation", description: "PLC, HMI, servo và biến tần cho máy móc và tủ điều khiển.", subcategories: ["PLC", "HMI", "Servo", "Biến tần"], visible: true, sortOrder: 8 },
  ],
  visibility: { announcement: true, hero: true, categories: true, featuredProducts: true, capabilities: true, contact: true, footer: true, floatingContact: true, search: true },
  appearance: { primaryColor: "#086ad8", secondaryColor: "#00a7c7", productsPerRow: 4, cardStyle: "comfortable" },
  content: {
    announcementPrimary:

...
export const seedProducts: Product[] = importedLaptopProducts

export const seedOrders: Order[] = [
  { id: 'DTPT-260701', createdAt: '2026-07-01T08:24:00.000Z', customer: { name: 'Nguyễn Minh Anh', phone: '0986 234 567', address: 'Hà Đông, Hà Nội', note: 'Gọi trước khi giao' }, items: [{ productId: 'DEV-037', quantity: 1 }], total: 7990000, status: 'new' },
  { id: 'DTPT-260630', createdAt: '2026-06-30T03:15:00.000Z', customer: { name: 'Trần Quang Huy', phone: '0912 888 686', address: 'Cầu Giấy, Hà Nội', note: '' }, items: [{ productId: 'DEV-019', quantity: 1 }], total: 28990000, status: 'confirmed' },
]
...
export const seedSettings: StoreSettings = {
  ...
  email: 'hello@dtpt.shop',
  facebook: 'facebook.com/dtpt.shop',
  content: {
    announcementPrimary: 'Miễn phí giao máy nội thành Hà Nội',
    announcementSecondary: 'Kiểm tra máy trước khi nhận',
    navProducts: 'Laptop',
    navWhy: 'Vì sao chọn DTPT Shop',
    navContact: 'Liên hệ',
    heroBadge: 'Laptop tuyển chọn · Bảo hành rõ ràng',
    heroTitle: 'Chiếc laptop đúng.',
    heroHighlight: 'Giá vừa tầm.',
    heroDescription: 'DTPT Shop chọn lọc từng chiếc máy theo nhu cầu thật: học tập, văn phòng, thiết kế hay gaming. Cấu hình rõ, giá minh bạch, tư vấn không vòng vo.',
    ...
    productsDescription: 'Mỗi sản phẩm đều hiển thị cấu hình và giá bán rõ ràng. Cần thêm thông tin? Chỉ cần gọi DTPT Shop.',
    whyEyebrow: 'VÌ SAO LÀ DTPT SHOP?',
    ...
    contactTitle: 'Gọi DTPT Shop, kể nhu cầu của bạn.',

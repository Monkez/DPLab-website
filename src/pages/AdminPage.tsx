...
const titles: Record<AdminTab, string> = {
  analytics: 'Lưu lượng truy cập', quotes: 'Yêu cầu báo giá', products: 'Danh mục sản phẩm', articles: 'Tin tức & bài viết', categories: 'Ngành hàng & phân loại', branding: 'Thương hiệu & liên hệ', content: 'Nội dung website', display: 'Giao diện & hiển thị', accounts: 'Tài khoản & phân quyền',
}
